...
#> ✓ Writing 'tmp' to: '/var/folders/t5/f77_gwnj6p95qxy9py3fckx00000gn/T//RtmpFGoYjE/file1f7468ab803f.csv'

# with a data frame in list
tmp$mtcars <- head(mtcars, 10)
write_list(tmp, file = tempfile(fileext = ".csv"))
#> ✓ Writing 'tmp' to: '/var/folders/t5/f77_gwnj6p95qxy9py3fckx00000gn/T//RtmpFGoYjE/file1f745370ddc8.csv'
```
